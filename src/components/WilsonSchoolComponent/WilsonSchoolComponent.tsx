import './WilsonSchoolComponent.css'
    ...
    <div>
      ...
      <div className="courses-flow">
        {courses.map((course, i) => {
          return (
            <CourseComponentCard key={i} name={course.name} courseCode={course.courseCode} description={course.description} skills={course.skills}></CourseComponentCard>
          )
        })}
      </div>
    </div>
